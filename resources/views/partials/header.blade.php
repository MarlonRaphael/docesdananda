            ...
            <div class="dropdown-menu dropdown-menu-left dropdown-menu-wide dropdown-menu-animated overflow-hidden">
              <div class="dropdown-row">
                ...
                <div
                  ...
                  <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium, commodi hic qui
                    aspernatur doloremque quos tempora placeat culpa illum, voluptatibus delectus provident cumque
                    aliquid enim, laborum aliquam. Quod, perferendis unde.</p>
                  <a href="../../dashboard1/ltr/pages/login/login-1.html" class="btn btn-light btn-wider">Login</a>
                </div>
                <!-- END Dropdown Column -->
                <!-- BEGIN Dropdown Column -->
                  ...
                  <div class="rich-list-prepend">
                    ...
                    <div class="avatar avatar-circle">
                      <div class="avatar-display">
                        <img src="{{ asset('assets/images/avatar/blank.webp') }}" alt="Avatar image">
                      </div>
                    </div>
                    <!-- END Avatar -->
                  </div>
