  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-12">
        <!-- BEGIN Portlet -->
        <div class="portlet">
          <form action="{{ resource_url($brand, 'update') }}" method="post">
            @csrf
            @method('put')
            <div class="portlet-header portlet-header-bordered">
              <h3 class="portlet-title">Editar marca</h3>
            </div>
                ...
                <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                  <div class="form-group">
                    ...
                    <input type="text" name="name" id="inputName"
                           ...
                           value="{{ old('name', $brand->name) }}" placeholder="Informe o nome" autofocus required>
                    @error('name')
