...
$(function () {
  ...
  $("#maxlength-2").maxlength({threshold: 5});
  $("#maxlength-3").maxlength({alwaysShow: true});
  $("#maxlength-4").maxlength({separator: " of ", preText: "You have ", postText: " chars remaining.", validate: true});
