...
$(function () {
    ...
    $("#datepicker-6").datepicker({orientation: direction, calendarWeeks: true});
    $(".input-daterange").datepicker({orientation: direction, todayHighlight: true});
    $("#datepicker-7").datepicker({orientation: direction, language: "ru"});
    $("#datepicker-8").datepicker({orientation: direction, todayHighlight: true})
});