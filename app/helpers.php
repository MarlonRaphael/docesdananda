...
if (!function_exists('resource_route')) {
  function resource_route(Model $model, string $action): string
  {
...
if (!function_exists('formatDateTime')) {
  function formatDateTime($expression)
  {
